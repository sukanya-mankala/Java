...
public class Activity11_4a {
    public static void main(String[] args) {
        ...
        String newTabText = driver.findElement(By.xpath("//div[contains(@class,'sub header')]")).getText();
        ...
        //Get heading on new page
        newTabText = driver.findElement(By.xpath("//div[contains(@class,'content')]")).getText();
        System.out.println("New tab heading is: " + newTabText);
